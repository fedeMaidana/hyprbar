...
pub struct Tokens {
    ...
    pub command_small_card_height: f32,
...
impl Default for Tokens {
    fn default() -> Self {
        Self {
            ...
            command_card_radius: 12.0,
            command_card_padding_x: 10.0,
            command_card_padding_y: 8.0,
            command_card_gap: 8.0,
            command_card_title_height: 16.0,
            command_wifi_card_height: 46.0,
            command_sound_card_height: 54.0,
            command_small_card_height: 40.0,
            command_icon_circle_radius: 13.0,
